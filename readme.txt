This is a password manger create by Bharghav, kanish, seyan and adhiraj to store user's passwords safe & securely.
...
for admin console run the BharZ_admin_gui.py.
